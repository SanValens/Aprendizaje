public class substring{ //Manipulador de cadenas de caracteres (string)
 ...
 System.out.println("substring(1):"+mystring.substring(1));
    //Todos los caracteres desde el uno, o sea... el segundo
  ...
  * is not present.
  *ESO QUE DICE DE LA RESTA EN LA SEGUNDA LINEA PROBABLEMENTE SEA PURA MIERDA
  */
